...
import Home from "@/app/posts/page";
const PostDetails = () => {
  const { id } = useParams();
  ...
  const posts = [
    {
      ...
      title: "The Magic of Mediterranean Cuisine",
      image: "/1.png",
      description: `The Mediterranean diet is more than just a way of eating—it's a lifestyle that embodies balance, simplicity, and health...`,
    },
    {
      id: 2,
      title: "Street Food Adventures: Tasting the World One Bite at a Time",
      image: "/2.png",
      description: `Street food is where you truly taste the heart of a city's culture. It’s vibrant, accessible, and brimming with authenticity...`,
    },
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-3xl font-bold text-blue-900 mt-4">{post.title}</h1>
        <p className="text-gray-700 mt-4">{post.description}</p>
      </div>
    </div>
  );
